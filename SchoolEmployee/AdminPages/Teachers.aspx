...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" OnRowInserting="ASPxGridView1_RowInserting" OnRowUpdating="ASPxGridView1_RowUpdating" OnRowDeleting="ASPxGridView1_RowDeleting" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="ID">
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Subjects">
                <EditItemTemplate>
                    <dx:ASPxGridLookup ID="GridLookup" runat="server" SelectionMode="Multiple" DataSourceID="SqlDataSource2"
                    ...
                    <asp:HiddenField runat="server" ID="HfieldID" Value='<%# Eval("ID")%>'/>
                    <asp:SqlDataSource runat="server" ID="SqlDataSource2"
                        ...
                        <SelectParameters>
                            <asp:ControlParameter PropertyName="Value" ControlID="HfieldID" Name="TeacherId" DefaultValue="-1"></asp:ControlParameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                </EditItemTemplate>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:SchoolDBConnectionString %>' DeleteCommand="DELETE FROM [Teacher] WHERE [ID] = @ID" SelectCommand="SELECT * FROM [Teacher]">
        <DeleteParameters>
